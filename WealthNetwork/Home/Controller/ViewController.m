...
- (void)initNaviBar{
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"icon_user2"] style:UIBarButtonItemStylePlain target:self action:@selector(leftBarClick)];
    
    UIBarButtonItem *searchBtn = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"icon_user2"] style:UIBarButtonItemStylePlain target:self action:@selector(searchBtnClick)];
    
    UIBarButtonItem *editBtn = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"icon_user2"] style:UIBarButtonItemStylePlain target:self action:@selector(editBtnClick)];
...
- (LeftViewController *)leftView{
    if (!_leftView) {
        _leftView = [[LeftViewController alloc]initWithMainVc:self.navigationController];
    }
    return _leftView;
}
- (NSArray *)dataList{
